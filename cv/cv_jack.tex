...
\underline{Yunhan Jia}, Yantao Lu, Junjie Shen, Qi Alfred Chen, Hao Chen, Zhenyu Zhong, Tao Wei,
Fooling Detection Alone is Not Enough: First Adversarial Attack against Multiple Object Tracking, International Conference on Learning Representations (\textbf{ICLR}), 2020 \href{https://openreview.net/pdf?id=rJl31TNYPr}{\color{blue}{[PDF]}}
